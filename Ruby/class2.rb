...
def get_total_for_customer(x)
  ...
  total = main_price + entre_price + dessert_price
...
def calculate_total_for_table_of_four()
  ...
  total_for_table = first_customer_price + second_customer_price + third_customer_price + fourth_customer_price

  return total_for_table
end
